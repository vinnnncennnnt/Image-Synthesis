...
//#include <ctime>
#include <unistd.h>
#include "../headers/textureur.h"
#include "../headers/descripteur_tache.h"
#include "../headers/raccordeur.h"
#include "../headers/raccordeur_simple.h"
...
int main(int argc, char **argv){
    ...
    switch(algo){
        ...
        case 3:
            ...
            break;
        case 4:
            tache.raccordeur = new RaccordeurRecursifNaifOptimise();
